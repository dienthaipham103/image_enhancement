...
Since the image tags (e.g. patient ID, hospital name, image sequence number, etc.) appeared in the upper part of the images, we also write a python script in order to blur these regions.
